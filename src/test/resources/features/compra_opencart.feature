...
Característica: Compra E2E en OpenCart con productos de distintas categorías
  ...
  @excepcional @validacion
  Escenario: La facturación falla si el email está en blanco
    Cuando agrega al carrito el producto "HP LP3065" de la categoría "Desktops"
    Y procede al checkout como invitado
    Y diligencia los datos de facturación dejando el email en blanco
    Entonces debería ver un mensaje de validación para el campo "E-Mail Address"

  @excepcional @validacion-formato
  Escenario: La facturación falla si el email tiene formato inválido
    Cuando agrega al carrito el producto "HP LP3065" de la categoría "Desktops"
    Y procede al checkout como invitado
    Y diligencia los datos de facturación con email mal formado "anderson_sin_arroba"
    Entonces debería ver un mensaje de validación para el campo "E-Mail Address"
